...
@section('content')
       ...
       {!! Form::open(['route'=>'productos.store','method'=>'POST']) !!}
            ...
            <div class="form-group">
                ...
                {!! Form::text('nombre_corto',null,['class'=>'form-control','placeholder'=>'Nombre corto del producto','required'])!!}
            </div>
            <div class="form-group">
			...
			<div class="form-group">
                ...
                {!! Form::select('ivaIncluido',$iva,null,['class'=>'form-control','required'])!!}
            </div>
            <div class="form-group">
                {!! Form::label('iva','Iva')!!}
